...
Так же используем key based way by user_id, применяем к user_id хэш функцию. Кроме информации о местах отдыха, они просто на отедельном хосте в отдельной таблице, предподготовленны.
