...
### Capasity - Комментарий

`345KB * 86400 * 365 = 10.9TB`

### Capasity - Реакция

`750KB * 86400 * 365 = 24TB`

### Capasity - Общее

`551TB + 10.9TB + 24TB = 585TB`
...
Capasity в дисках `585TB / 0.85(15% объема диска как правило недоступны) = 670TB`

Для данной системы выберем `HHD диски`(Так как SSD конфигурация будет очень дорогая), нужно `186 Дисков по 4TB`
